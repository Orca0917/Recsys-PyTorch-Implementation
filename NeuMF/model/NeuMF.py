...
class NeuMF(torch.nn.Module):
    ...
    def load_pretrain_weights(self):
        ...
        if config['use_cuda'] is True: mlp_model.cuda()
        ...
        if config['user_cuda'] is True: gmf_model.cuda()
        resume_checkpoint(gmf_model, model_dir=config['pretrian_mf'], device_id=config['device_id'])
